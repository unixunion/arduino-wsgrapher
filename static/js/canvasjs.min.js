...
(function() {
    ...
    function z(a, b, c, d) {
        ...
        if (this._options.stripLines && 0 < this._options.stripLines.length)
            for (this.stripLines = [], b = 0; b < this._options.stripLines.length; b++)
                this.stripLines.push(new ma(this.chart,
        ...
        for (t = n = k = m = p = 0; 0 < h.length;)
            if (b = h.pop(), "#" === b || "0" === b)
                if (p++, p === r) {
                    var u = g, g = [];
                    if ("0" === b)
                        for (b = r - m - (u ? u.length : 0); 0 < b;)
                            u.unshift("0"), b--;
                            for (; 0 < u.length;)
                                c = u.pop() + c, t++, 0 === t%n && (k === q && 0 < u.length) && (c = f + c);
                                d && (c = "-" + c)
                } else 
                    0 < g.length ? (c = g.pop() +
                    c, m++, t++) : "0" === b && (c = "0" + c, m++, t++), 0 === t%n && (k === q && 0 < g.length) && (c = f + c);
                else 
                    "E" !== b[0] && "e" !== b[0] || "0" !== b[b.length - 1] ||!/[eE][+-]*[0]+/.test(b) ? "," === b ? (k++, n = t, t = 0, 0 < g.length && (c = f + c)) : c = 1 < b.length && ('"' === b[0] && '"' === b[b.length - 1] || "'" === b[0] && "'" === b[b.length - 1]) ? b.slice(1, b.length - 1) + c : b + c : (b = 0 > s ? b.replace("+", "").replace("-", "") : b.replace("-", ""), c += b.replace(/[0]+/, function(a) {
                        return K(s, a.length)
                    }));
        d = "";
        for (f=!1; 0 < l.length;)
            b = l.shift(), "#" === b || "0" === b ? 0 < a.length && 0 !== Number(a.join("")) ?
    ...
    v.prototype._updateOptions = function() {
        ...
        this._options.zoomEnabled ? (this._zoomButton || (S(this._zoomButton = document.createElement("button")), M(this, this._zoomButton, "pan"), this._toolBar.appendChild(this._zoomButton), E(this._zoomButton, "click", function() {
            ...
            a.render()
        }), this.overlaidCanvas.style.cursor = a._defaultCursor), this.zoomEnabled || this.panEnabled || (this._zoomButton ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ? (this.panEnabled =
        !0, this.zoomEnabled=!1) : (this.zoomEnabled=!0, this.panEnabled=!1), ka(a._zoomButton, a._resetButton)) : (this.zoomEnabled=!0, this.panEnabled=!1))) : this.panEnabled = this.zoomEnabled=!1;
    ...
    v.prototype.render = function(a) {
        ...
        0 < b.length ? (p.disableToolTip=!0, p._animator.animate(200, p.animationDuration, function(a) {
            ...
            for (var d = 0; d < b.length; d++)
                g = b[d], 1 > a && "undefined" !== typeof g.startTimePercent ? a >= g.startTimePercent && g.animationCallback(g.easingFunction(a - g.startTimePercent, 0, 1, 1 - g.startTimePercent), g) : g.animationCallback(g.easingFunction(a,
                0, 1, 1), g)
        }, function() {
            b = [];
            for (var a = 0; a < p.plotInfo.plotTypes.length; a++)
                for (var d = p.plotInfo.plotTypes[a], e = 0; e < d.plotUnits.length; e++)
                    d.plotUnits[e].targetCanvas = null;
            c = null;
            p.disableToolTip=!1
    ...
    v.prototype._processStackedPlotUnit = function(a) {
        if (a.dataSeriesIndexes&&!(1 > a.dataSeriesIndexes.length)) {
            ...
            for (l in g)
                isNaN(l) || (a = g[l], a < b.min && (b.min = a), a > b.max && (b.max = a), l < c.viewPortMin || l > c.viewPortMax || (a < b.viewPortMin && (b.viewPortMin = a), a > b.viewPortMax && (b.viewPortMax = a)));
            for (l in k)
                isNaN(l) || (a = k[l], a < b.min && (b.min = a), a > b.max && (b.max = a), l < c.viewPortMin || l > c.viewPortMax || (a < b.viewPortMin &&
        ...
        if (a.dataSeriesIndexes&&!(1 > a.dataSeriesIndexes.length)) {
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f=!1, g=!1, k=!1, p = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement)
                    var n = this.sessionVariables.axisX.internalMinimum ? this.sessionVariables.axisX.internalMinimum: this._options.axisX &&
                ...
                if (l.dataPoints[r].x && l.dataPoints[r].x.getTime || "dateTime" === l.xValueType)
                    f=!0;
    ...
    v.prototype._processMultiYPlotUnit = function(a) {
        if (a.dataSeriesIndexes&&!(1 > a.dataSeriesIndexes.length))
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f, g, k=!1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement)
                    var q = this.sessionVariables.axisX.internalMinimum ?
    ...
    v.prototype.getObjectAtXY = function(a, b, c) {
        ...
        if (c = this.getDataPointAtXY(a, b, c ||!1))
            ...
            d = ta(a, b, this._eventManager.ghostCtx);
        else 
        ...
        if (a.changedTouches && this.interactivityEnabled) {
            ...
            if (!(c && 1 < c.length)) {
                ...
                if (this._lastTouchData.scroll && this.zoomEnabled)
                    this.isDrag && this.resetOverlayedCanvas(), this.isDrag =
                    !1;
                else 
                    for (c = 0; c < b.length; c++)
                        e = b[c], f = document.createEvent("MouseEvent"), f.initMouseEvent(e, !0, !0, window, 1, d.screenX, d.screenY, d.clientX, d.clientY, !1, !1, !1, !1, 0, null), d.target.dispatchEvent(f), a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault()
                    }
        }
    };
            ...
            if (this._ignoreNextEvent)
                ...
                if (!e) {
                    if (v.capturedEventParam)
                        d = v.capturedEventParam, "mouseup" === c && (v.capturedEventParam = null, d.chart.overlaidCanvas.releaseCapture ? d.chart.overlaidCanvas.releaseCapture() : document.body.removeEventListener("mouseup", d.chart._mouseEventHandler, !1)), d.hasOwnProperty(c) && d[c].call(d.context, b.x, b.y);
    ...
    v.prototype._plotAreaMouseUp = function(a, b) {
        ...
        this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            ...
            if (2 < Math.abs(e)) {
                if (this.panEnabled)
                    e=!1, d = 0, this.axisX.sessionVariables.internalMinimum < this.axisX._absoluteMinimum ? (d = this.axisX._absoluteMinimum - this.axisX.sessionVariables.internalMinimum, this.axisX.sessionVariables.internalMinimum +=
        ...
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if (2 < Math.abs(c) && (this.panEnabled || this.zoomEnabled))
                if (this.panEnabled) {
                    ...
                    this.zoomEnabled && (c = this.plotArea, this.resetOverlayedCanvas(), d = this.overlaidCanvasCtx.globalAlpha, this.overlaidCanvasCtx.globalAlpha = 0.7, this.overlaidCanvasCtx.fillStyle = "#A0ABB8", "xySwapped" === this.plotInfo.axisPlacement ? this.overlaidCanvasCtx.fillRect(c.x1, this.dragStartPoint.y, c.x2 - c.x1, b - this.dragStartPoint.y) :
                    ...
                    for (var q=!1, l = 0; l < k.length; l++)
                        if (r = k[l].getTime ? k[l].x.getTime() : k[l].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof k[l].y)
                                ...
                                if (0 < k[l].markerSize || 0 < g.markerSize)
                                    n = g.getMarkerProperties(l, r, m, b), d.push(n), s = C(s), t && d.push({
                                        x: r,
                                        y: m,
                                        ctx: c,
                                        type: n.type,
        ...
        function b(a) {
            ...
            if (0 < a.length) {
                ...
                for (var b = 0; b < a.length - 3; b += 3)
                    c.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y), t && d.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y), 0 <
                    ...
                    for (g = 0; g < q.length; g++)
                        if (c = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[g].y) {
                            ...
                            if (0 <= q[g].y) {
                                ...
                                x = f[c] ? f[c] : 0, u = k + x, k = p + x, f[c] = x + (u - k);
                    ...
                    for (g = 0; g < q.length; g++)
                        if (c = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[g].y) {
                            ...
                            if (0 <= q[g].y) {
                                ...
                                x = f[c] ? f[c] : 0, u = k - x, k = p - x, f[c] = x + (k - u);
                                c = q[g].color ? q[g].color : m._colorSet[g%m._colorSet.length];
        ...
        function b() {
            ...
            if (0 < b.length) {
                ...
                for (var g = 0; g < b.length - 3; g += 3)
                    c.bezierCurveTo(b[g + 1].x, b[g + 1].y, b[g + 2].x, b[g +
                ...
                if (0 < g.length) {
                    ...
                    for (k = 0; k < g.length; k++) {
                        ...
                        if (!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof x.y) {
                            ...
                            f[l] = r - h;
                            if (B)
                                b.beginPath(), b.moveTo(p, h), t && (m.beginPath(), m.moveTo(p, h)), B=!1;
                            else if (b.lineTo(p,
                    ...
                    for (0 < n.lineThickness && b.stroke(); 0 < u.length;)
                        v = u.pop(), b.lineTo(v.x, v.y), t && m.lineTo(v.x,
                        v.y);
                    b.closePath();
                    b.globalAlpha = n.fillOpacity;
                    b.fill();
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                for (k = 0; k < u.length; k++)
                    s = u[k].x.getTime ? u[k].x.getTime() : u[k].x, B.dataPointIndexes[s] = k, xValuePresent[s] || (g.push(s), xValuePresent[s]=!0);
                g.sort(ra)
            }
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < g.length) {
                    ...
                    for (k = 0; k < g.length; k++) {
                        l = g[k];
                        var v = null, v = 0 <= B.dataPointIndexes[l] ? u[B.dataPointIndexes[l]]: {
                            x: l,
                            y: 0
                        };
                        if (!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof v.y) {
                            ...
                            f[l] = r - h;
                            if (x)
                                b.beginPath(), b.moveTo(p, h), t && (n.beginPath(), n.moveTo(p, h)), x=!1;
                    ...
                    for (0 < B.lineThickness && b.stroke(); 0 < w.length;)
                        A = w.pop(), b.lineTo(A.x, A.y), t && n.lineTo(A.x, A.y);
                    b.closePath();
                    b.globalAlpha = B.fillOpacity;
                    b.fill();
                    b.globalAlpha = 1;
    ...
    v.prototype.renderBubble = function(a) {
        ...
        if (!(0 >= c)) {
            ...
            for (var p =- Infinity, h = Infinity, l = 0; l < a.dataSeriesIndexes.length; l++)
                for (var r = a.dataSeriesIndexes[l], m = this.data[r], q = m.dataPoints, n = 0, e = 0; e < q.length; e++)
                    f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (n = q[e].z, n > p && (p = n), n < h && (h = n));
                ...
                if (0 < r.length)
                    for (var m = 5 < k && l.bevelEnabled?!0 : !1, e = 0; e < r.length; e++)
                        ...
                        g = r[e].x.getTime() : g = r[e].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && null !== r[e].y && r[e].y.length && "number" === typeof r[e].y[0] && "number" === typeof r[e].y[1]) {
                            ...
                            if (r[e].indexLabel || l.indexLabel)
                                this._indexLabels.push({
                ...
                if (0 < m.length) {
                    ...
                    for (e = 0; e < m.length; e++)
                        ...
                        null !== m[e].y && m[e].y.length && "number" === typeof m[e].y[0] && "number" === typeof m[e].y[1]) {
                            ...
                            if (m[e].indexLabel || r.indexLabel)
                                this._indexLabels.push({
                                    chartType: "rangeBar",
                                    dataPoint: m[e],
                                    dataSeries: r,
                    ...
                    for (var x=!0; r < h.length; r++)
                        if (s = h[r].x.getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))
                            if (null !== h[r].y && h[r].y.length && "number" === typeof h[r].y[0] && "number" === typeof h[r].y[1]) {
                                ...
                                if (h[r].indexLabel || p.indexLabel)
                                    this._indexLabels.push({
                                        chartType: "rangeArea",
                                        dataPoint: h[r],
                                        dataSeries: p,
        ...
        function b() {
            ...
            if (0 < a.length) {
                ...
                for (b = a.length - 1; 2 < b; b -= 3)
                    c.bezierCurveTo(a[b - 1].x, a[b - 1].y, a[b - 2].x, a[b - 2].y, a[b - 3].x, a[b - 3].y), t && d.bezierCurveTo(a[b -
                    ...
                    for (c.lineWidth = k.lineThickness; h < p.length; h++)
                        if (l = p[h].x.getTime ? p[h].x.getTime() : p[h].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax))
                            if (null !== p[h].y && p[h].y.length && "number" === typeof p[h].y[0] && "number" === typeof p[h].y[1]) {
                                ...
                                if (p[h].indexLabel || k.indexLabel)
                                    this._indexLabels.push({
                                        chartType: "splineArea",
                                        dataPoint: p[h],
                                        dataSeries: k,
    ...
    v.prototype.renderPie = function(a) {
            ...
            if (h && l) {
                ...
                for (z = 0; z < l.length; z++) {
                    ...
                    if (f.midAngle > Math.PI / 2 - u && f.midAngle < Math.PI / 2 + u) {
                        if (0 === a || n[c].midAngle > f.midAngle)
                            c = z;
                        a++
                    } else if (f.midAngle > 3 * Math.PI / 2 - u && f.midAngle < 3 * Math.PI / 2 + u) {
                        if (0 === b || n[d].midAngle > f.midAngle)
                            d = z;
                        b++
                    }
                ...
                k=!1;
                for (z = 0; z < l.length; z++)
                    f = n[(c + z)%l.length], 1 < a && (f.midAngle > Math.PI / 2 - u && f.midAngle < Math.PI / 2 + u) && (e <= a / 2&&!k ? (f.hemisphere = "right", e++) : (f.hemisphere = "left", k=!0));
                k=!1;
                for (z = 0; z < l.length; z++)
                    f = n[(d + z)%l.length], 1 < b && (f.midAngle > 3 * Math.PI / 2 - u && f.midAngle < 3 * Math.PI / 2 + u) && (g <= b / 2&&!k ? (f.hemisphere =
        ...
        function c(a) {
            ...
            for (b = 0; b < l.length; b++) {
                ...
                if (d > c) {
                    ...
                    if (l[b].exploded) {
                        if (1E-9 < Math.abs(n[b].center.x - (w.x + e)) || 1E-9 < Math.abs(n[b].center.y - (w.y + f)))
                            n[b].center.x = w.x + e * a, n[b].center.y = w.y + f * a, g=!0
                    } else if (0 < Math.abs(n[b].center.x -
                    w.x) || 0 < Math.abs(n[b].center.y - w.y))
                        n[b].center.x = w.x + e * (1 - a), n[b].center.y = w.y + f * (1 - a), g=!0;
            ...
            for (b = b = 0; b < l.length; b++)
                c = n[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height /
        ...
        function f(a) {
            for (var b = null, c = 1; c < l.length; c++)
                ...
                (a + c + n.length)%n.length, n[b].hemisphere !== n[a].hemisphere) {
                    b = null;
                    break
                } else if (n[b].indexLabelText && b !== a && (0 > e(n[b], n[a]) || ("right" === n[a].hemisphere ? n[b].indexLabelTextBlock.y >= n[a].indexLabelTextBlock.y : n[b].indexLabelTextBlock.y <= n[a].indexLabelTextBlock.y)))
                    break;
                else 
                    b = null;
            return b
        ...
        function g(a, b) {
            ...
            if (0 <= a && a < l.length) {
                var m = n[a];
                if (0 > b && m.indexLabelTextBlock.y < d || 0 < b && m.indexLabelTextBlock.y > h)
                    return 0;
                ...
                for (h = 1; h < l.length; h++)
                    if (d = (a - h + n.length)%n.length, n[d].hemisphere !== n[a].hemisphere) {
                        d = null;
                        break
                    } else if (n[d].indexLabelText && n[d].hemisphere === n[a].hemisphere && d !== a && (0 > e(n[d], n[a]) || ("right" === n[a].hemisphere ? n[d].indexLabelTextBlock.y <= n[a].indexLabelTextBlock.y : n[d].indexLabelTextBlock.y >= n[a].indexLabelTextBlock.y)))
                        break;
                    else 
                        d = null;
                r = d;
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            m.height) / 2 : 0.8 * Math.min(m.width, m.height) / 2, A = y * t, C = 0, z = 0; z < l.length; z++)
                C += Math.abs(l[z].y);
    ...
    I.prototype.render = function(a) {
        ...
        for (c = 0; c < this._wrappedText.lines.length; c++)
            f = this._wrappedText.lines[c], "right" === this.horizontalAlign ? d = this.width - f.width - this.padding : "left" === this.horizontalAlign ? d = this.padding : "center" === this.horizontalAlign &&
    ...
    ga.prototype.render = function() {
        ...
        for (var p = 0; p < this.dataSeries.length; p++) {
            ...
            if ("pie" !== h.type && "doughnut" !== h.type && "funnel" !== h.type)
                ...
                for (var t = 0; t < h.dataPoints.length; t++)
                    s = h.dataPoints[t], l = s.legendMarkerType ? s.legendMarkerType : h.legendMarkerType ? h.legendMarkerType : P.getDefaultLegendMarker(h.type), r = s.legendText ?
        ...
        if (0 < g.length) {
            ...
            for (p = t = 0; p < g.length; p++) {
                ...
                if ("horizontal" === this.orientation) {
                    ...
                    if (!h || h.width + l.textBlock.width + (0 === h.width ? 0 : this.horizontalSpacing) > e)
                        h = {
                            items: [],
                            width: 0
        ...
        for (p = 0; p < this.items.length; p++)
            l = g[p], l.id=++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[l.id] = {
            id: l.id,
        ...
        for (p = 0; p < k.length; p++)
            for (h = k[p], a = 0; a < h.items.length; a++) {
                ...
                if ("line" === l.chartType || "stepLine" === l.chartType || "spline" === l.chartType)
                    this.ctx.strokeStyle = l.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(f - 0.1 * this.lineHeight, g + this.lineHeight / 2), this.ctx.lineTo(f + 0.7 * this.lineHeight, g + this.lineHeight / 2), this.ctx.stroke(), e -= 0.1 * this.lineHeight;
    ...
    P.prototype.getDefaultAxisPlacement = function() {
        var a = this.type;
        if ("column" === a || "line" ===
        a || "stepLine" === a || "spline" === a || "area" === a || "stepArea" === a || "splineArea" === a || "stackedColumn" === a || "stackedLine" === a || "bubble" === a || "scatter" === a || "stackedArea" === a || "stackedColumn100" === a || "stackedLine100" === a || "stackedArea100" === a || "candlestick" === a || "ohlc" === a || "rangeColumn" === a || "rangeArea" === a || "rangeSplineArea" === a)
            return "normal";
    ...
    P.getDefaultLegendMarker = function(a) {
        ...
        a || "stackedArea" === a || "stackedArea100" === a)
            return "triangle";
            ...
            if (0 <= f && f < this.dataPoints.length) {
                ...
                if (m) {
                    ...
                    case "ohlc":
                        ...
                        m.borderThickness / 2 && b <= m.y1 + m.borderThickness / 2 || a >= (m.x1 + m.x2) / 2 && a <= m.x2 && b >= m.y4 - m.borderThickness / 2 && b <= m.y4 + m.borderThickness / 2)
                            d.push({
                                dataPoint: q,
                                dataPointIndex: f,
                                dataSeries: this,
    ...
    z.prototype.createLabels = function() {
        ...
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType)
            for (c =
            qa(new Date(this.maximum), this.interval, this.intervalType), b = this.intervalstartTimePercent; b < c; qa(b, this.interval, this.intervalType)
                )a = b.getTime(), a = "axisX" === this.type && this.labels[a] ? this.labels[a] : ya(b, this.valueFormatString, this.chart._cultureInfo), a = new I(this.ctx, {
            x: 0,
            y: 0,
            maxWidth: d,
            maxHeight: e,
            ...
            for (b = this.intervalstartTimePercent; b <= c; b = parseFloat((b + this.interval)
                .toFixed(14)))a = "axisX" === this.type && this.labels[b] ? this.labels[b] : X(b, this.valueFormatString,
        ...
        for (b = 0; b < this.stripLines.length; b++)
            c = this.stripLines[b], a = new I(this.ctx, {
                x: 0,
                y: 0,
    ...
    z.prototype.renderLabelsTicksAndTitle = function() {
        ...
        if ("undefined" === typeof this._options.interval) {
            ...
            if ("left" === this._position || "right" === this._position) {
                for (e = 0; e < this._labels.length; e++)
                    f = this._labels[e], f.position < this.minimum || f.stripLine || (f = f.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + f.textBlock.width *
        ...
        if ("bottom" === this._position) {
            for (var e = 0, f, e = 0; e < this._labels.length; e++)
                if (f = this._labels[e], !(f.position < this.minimum || f.position > this.maximum)) {
                    ...
                    if (this.tickThickness&&!this._labels[e].stripLine || this._labels[e].stripLine && "pixel" === this._labels[e].stripLine._thicknessType)
                        this._labels[e].stripLine ? (c = this._labels[e].stripLine, this.ctx.lineWidth = c.thickness, this.ctx.strokeStyle =
                        ...
                        if (!a || 0 === d++%2 || this._labels[e].stripLine)
                            0 === f.textBlock.angle ? (b.x -= f.textBlock.width / 2, b.y += this.tickLength + f.textBlock.fontSize / 2) : (b.x -= 0 > this.labelAngle ? f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0, b.y += this.tickLength + Math.abs(0 > this.labelAngle ?
            ...
            for (e = 0; e < this._labels.length; e++)
                if (f = this._labels[e], !(f.position < this.minimum || f.position > this.maximum)) {
                    ...
                    this._labels[e].stripLine && "pixel" === this._labels[e].stripLine._thicknessType)
                        ...
                        if (!a || 0 === d++%2 || this._labels[e].stripLine)
                            0 === f.textBlock.angle ? (b.x -= f.textBlock.width /
            ...
            for (e = 0; e < this._labels.length; e++)
                if (f = this._labels[e], !(f.position < this.minimum || f.position > this.maximum)) {
                    ...
                    this._labels[e].stripLine && "pixel" === this._labels[e].stripLine._thicknessType)
                        this._labels[e].stripLine ? (c = this._labels[e].stripLine, this.ctx.lineWidth = c.thickness, this.ctx.strokeStyle = c.color) : (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor), c = 1 === this.ctx.lineWidth%2 ? (b.y<<0) + 0.5 : b.y<<0, this.ctx.beginPath(), this.ctx.moveTo(b.x<<0, c), this.ctx.lineTo(b.x + this.tickLength<<0, c), this.ctx.stroke();
                        if (!a || 0 === d++%2 || this._labels[e].stripLine)
                            f.textBlock.x = b.x + this.tickLength +
    ...
    z.prototype.renderInterlacedColors = function() {
        ...
        if (("bottom" === this._position || "top" === this._position) && this.interlacedColor)
            ...
            for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++)
                this._labels[e].stripLine || (b ? (c = this.getPixelCoordinatesOnAxis(this._labels[e].position), b = e + 1 >= this._labels.length ? this.getPixelCoordinatesOnAxis(this.maximum) :
            ...
            for (var b = this.chart.plotArea.ctx, c = 0, c = 0; c < this.stripLines.length; c++) {
                ...
                if (d._thicknessType === a && ("pixel" !== a ||!(d.value < this.minimum || d.value > this.maximum))) {
                    ...
                    if (!(0 >= f)) {
                        ...
                        b.lineWidth = f;
                        if ("bottom" === this._position || "top" === this._position)
                            g = k = 1 === b.lineWidth%2 ? (e.x<<0) + 0.5 : e.x<<0, p = this.chart.plotArea.y1, h = this.chart.plotArea.y2;
                        else if ("left" === this._position || "right" === this._position)
                            p = h = 1 === b.lineWidth%2 ? (e.y<<0) + 0.5 : e.y<<0, g = this.chart.plotArea.x1, k = this.chart.plotArea.x2;
                            b.moveTo(g, p);
                            b.lineTo(k, h);
                            b.stroke()
                        }
        ...
        if (this.gridThickness && 0 < this.gridThickness) {
            ...
            if ("bottom" === this._position || "top" === this._position)
                for (d = 0; d < this._labels.length&&!this._labels[d].stripLine; d++)
                    this._labels[d].position < this.minimum || this._labels[d].position > this.maximum || (a.beginPath(), b = this.getPixelCoordinatesOnAxis(this._labels[d].position), b = 1 === a.lineWidth%2 ? (b.x<<0) + 0.5 : b.x<<0, a.moveTo(b, c.y1<<0), a.lineTo(b, c.y2<<
                    0), a.stroke());
            else if ("left" === this._position || "right" === this._position)
                for (var d = 0; d < this._labels.length&&!this._labels[d].stripLine; d++)
                    this._labels[d].position < this.minimum || this._labels[d].position > this.maximum || (a.beginPath(), b = this.getPixelCoordinatesOnAxis(this._labels[d].position), b = 1 === a.lineWidth%2 ? (b.y<<0) + 0.5 : b.y<<0, a.moveTo(c.x1<<0, b), a.lineTo(c.x2<<0, b), a.stroke())
        }
    };
    z.prototype.renderAxisLine = function() {
        ...
        if ("bottom" === this._position || "top" === this._position) {
            ...
            "left" !== this._position && "right" !== this._position ||!this.lineThickness || (a.lineWidth = this.lineThickness, a.strokeStyle = this.lineColor, b = 1 === this.lineThickness%2 ? (this.lineCoordinates.x1<<0) + 0.5 : this.lineCoordinates.x1<<0, a.beginPath(), a.moveTo(b,
    ...
    z.prototype.getPixelCoordinatesOnAxis = function(a) {
        ...
        if ("left" === this._position || "right" === this._position)
            c = d / Math.abs(this.maximum - this.minimum), b.y = this.lineCoordinates.y2 - c * (a - this.minimum), b.x =
    ...
    z.prototype.getLabelStartPoint = function() {
        ...
        if ("millisecond" !== this.intervalType)
            if ("second" === this.intervalType)
                0 < a.getMilliseconds() && (a.setSeconds(a.getSeconds() +
                ...
                if (0 < a.getHours() || 0 < a.getMinutes() || 0 < a.getSeconds() || 0 < a.getMilliseconds())
                    a.setDate(a.getDate() + 1), a.setHours(0),
    ...
    N.prototype._updateToolTip = function(a, b) {
        if (this.enabled&&!this.chart.disableToolTip) {
            ...
            t ? (g = ta(a, b, this.chart._eventManager.ghostCtx), 0 < g && "undefined" !== typeof this.chart._eventManager.objectMap[g] ? (eventObject = this.chart._eventManager.objectMap[g], this.currentSeriesIndex = eventObject.dataSeriesIndex, this.currentDataPointIndex = 0 <= eventObject.dataPointIndex ? eventObject.dataPointIndex : - 1) : this.currentDataPointIndex =- 1) : this.currentDataPointIndex =- 1, 0 <= this.currentSeriesIndex) {
                ...
                else if ("line" === d.type || "stepLine" === d.type || "spline" === d.type || "area" === d.type || "stepArea" === d.type || "splineArea" === d.type || "stackedArea" === d.type || "stackedArea100" === d.type || "rangeArea" === d.type || "rangeSplineArea" === d.type || "candlestick" === d.type || "ohlc" === d.type)
            ...
            for (var c = 0, d = 0; d < a.length; d++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    ...
                    "stepArea" === c.type || "splineArea" === c.type || "stackedArea" === c.type || "stackedArea100" === c.type || "rangeArea" === c.type || "rangeSplineArea" === c.type) {
                        ...
                        "bubble" === c.type ? (g = c.getMarkerProperties(f, e.x1, e.y1, this.chart.overlaidCanvasCtx), g.size = e.size, g.color = "white", g.borderColor = "white", b.globalAlpha = 0.3, J.drawMarkers([g]), b.globalAlpha = 1) : "column" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "bar" === c.type || "rangeBar" === c.type || "stackedBar" === c.type || "stackedBar100" === c.type || "rangeColumn" === c.type ? F(b, e.x1, e.y1, e.x2,
            ...
            for (var p = "", k = 0; k < a.length; k++)
                ...
                null !== c._options.toolTipContent)) {
                    if ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" === c.type || "scatter" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "stackedBar" === c.type || "stackedBar100" === c.type || "stackedArea" === c.type || "stackedArea100" === c.type)
                        ...
                        f += d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"'color:{color};'\"'>{name}:</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}";
                    ...
                    "rangeArea" === c.type || "rangeSplineArea" === c.type)
                        f += d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"'color:{color};'\"'>{name}:</span>&nbsp;&nbsp;{y[0]},&nbsp;{y[1]}";
    ...
    v.prototype.replaceKeywordsWithValue = function(a, b, c, d, e) {
        ...
        "doughnut" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            ...
            if (0 <= c.type.indexOf("stacked"))
                k = 0, p = b.x.getTime ? b.x.getTime() : b.x, p in c.plotUnit.yTotals && (k = c.plotUnit.yTotals[p], g = isNaN(b.y) ? 0 : 100 * (b.y / k));
            else if ("pie" === c.type || "doughnut" === c.type) {
                for (i = k = 0; i < c.dataPoints.length; i++)
                    isNaN(c.dataPoints[i].y) || (k += c.dataPoints[i].y);
    ...
    oa.prototype.animate = function(a, b, c, d, e) {
        ...
        for (a = []; 0 < this.animations.length;)
            ...
            b.duration), 0, 1, b.duration), d = Math.min(d, 1), isNaN(d) ||!isFinite(d)) && (d = 1), 1 > d && a.push(b), b.animationCallback(d), 1 <= d && b.onComplete)
                b.onComplete();
        this.animations = a;
